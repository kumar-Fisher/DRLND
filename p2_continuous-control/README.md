...
![Trained Agent](p2_continous-control.gif)
...
### Step 2: Clone the repo
    Clone this repo using git clone https://github.com/kumar-Fisher/DRLND.git and go to `p2_continuous-control/` folder


### Instructions running Continuous_Control.ipynb
...
4.  Once the model is trained for actor and critic it will be saved in modesl folder seprately in saved_model_actor.pth and saved_model_critic.pth seprately.
