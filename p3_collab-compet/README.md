...
### Step 2: Clone the repo
    Clone this repo using git clone https://github.com/kumar-Fisher/DRLND.git and go to `p3_collab-compet/` folder 

### Run Tennis.ipynb file
### Instructions running Tennis.ipynb
...
4.  Once the model is trained for actor and critic it will be saved in modesl folder.
